...
class DownloadTask: NSObject,NSURLSessionDownloadDelegate {
    ...
    */
    ...
    //***********************************************************************
    func initWithImageUrl(url: NSURL, withOperationQueue queue:NSOperationQueue, withCompletionHandler completionHandler:DownloadingImageCompletionBlock, withDownloadProgressHandler progressHandler:DownloadingImageProgressBlock) -> DownloadTask {
        
        var downloadingTask:DownloadTask = DownloadTask()
